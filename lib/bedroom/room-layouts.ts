...
export const INITIAL_ROOMS: RoomLayout[] = [
  ...
  },
  {
    ...
    items: [
      { id: "small-sofa-bed", assetId: "sofa-bed", name: "1200 折叠沙发床", position: { x: 600, z: 1000 }, rotation: 0, size: { width: 1200, depth: 2000, height: 720 }, color: "#c9c2d5" },
      ...
      { id: "small-chair", assetId: "desk-chair", name: "书桌椅", position: { x: 1800, z: 700 }, rotation: 90, size: { width: 420, depth: 420, height: 800 }, color: "#826f8f" },
    ],
  },
];
